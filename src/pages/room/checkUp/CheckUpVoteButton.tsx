        ...
        <div className="flex justify-center space-x-2">
            <button
                ...
                className={`
                    ...
                    font-noto 
                    text-xs 
                    ${disabled ? "bg-gray-400" : "bg-blue-100 hover:bg-blue-200"} 
                    ${clickedVote === "아직이요" ? "text-white" : clickedVote === "이해했어요" ? "text-white" : "text-blue-600"}
                `}
            >
                아직이요
            </button>
            ...
            <button
                ...
                className={`
                    ...
                    ${clickedVote === "이해했어요" ? "text-white" : clickedVote === "아직이요" ? "text-white" : "text-white"}
                `}
            >
                이해했어요
            </button>
