...
const CheckUp = ({ onSubmit }: CheckUpProps) => {
  ...
  return (
    <div
      className="bg-white p-5 rounded shadow-md mb-4"
    ...
    >
      {formVisible ? (
        ...
        >
          <label
            className="text-black font-bold w-full text-left mb-4"
            style={{ fontSize: "1rem" }}
          >
            Q&A 내용
          </label>
        ...
        <div
          className="text-black flex flex-col item-start"
        ...
        >
          <div className="flex items-center font-bold">
            ...
            />
            <p className="text-base mb-4" style={{ fontSize: "0.875rem" }}>
              {submittedTitle}
            </p>
          </div>
          <p className="text-base mb-4" style={{ fontSize: "0.875rem" }}>
